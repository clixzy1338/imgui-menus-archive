...
namespace ImGui
{
    ...
    IMGUI_API bool          SubTab(const char* label, bool active, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API bool          renderer_tab(const char* icon, const char* text, bool selected);
    ...
    IMGUI_API bool          tab(const char* text, const char* icon, bool selected);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColor_Rounded(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding, ImDrawCornerFlags flags = ImDrawCornerFlags_All);
